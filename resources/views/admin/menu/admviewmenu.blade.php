            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        {!! Form::open (['route' => 'menuA.index', 'method' => 'GET', 'class' => 'navbar-form navbar-left pull-right','role' => 'search'])!!}
                            ...
                            <table width="100%" class="table table-striped table-bordered table-responsive table-hover" id="dataTables-servi">
                                 {!!link_to_route('menuA.create', 'Crear nuevo menú', null, ['class'=>'btn btn-success '])!!}
                                <thead>
                                    <tr>
                                        <th>Sopa</th>
                                        <th>Plato Fuerte</th>
                                ...
                                <tbody>
                                    <tr class="gradeX">
                                        ...
                                        <td>{{$men->fecha}}</td>
                                        <td class="center">{!!link_to_route('menuA.edit', 'Editar', $men->id,  ['class'=>'btn btn-primary'])!!}
                                        {!!link_to_route('menuA.destroy', 'Eliminar', $men->id,  ['onclick'=>"return confirm('¿Desea Eliminarlo?')" , 'class'=>'btn btn-danger'])!!}
                                      </td></td>
                                    </tr>
                                </tbody>
                                @endforeach
