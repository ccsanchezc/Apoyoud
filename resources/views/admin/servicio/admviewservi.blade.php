            ...
            <div class="row">
                ...
                @endif
                    <div class="panel panel-default">
                        ...
                        {!! Form::open (['route' => 'serviA.index', 'method' => 'GET', 'class' => 'navbar-form navbar-left pull-right','role' => 'search'])!!}
                            ...
                            <table width="100%" class="table table-striped table-bordered table-responsive table-hover" id="dataTables-servi">
                                 {!!link_to_route('serviA.create', 'Crear nuevo servicio', null, ['class'=>'btn btn-success '])!!}
                                <thead>
                                    <tr>
                                        <th>Nombre</th>
                                        <th>Descripción</th>
                                ...
                                <tbody>
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">{!!link_to_route('serviA.edit', 'Editar', $servis->id,  ['class'=>'btn btn-primary'])!!}
                                        {!!link_to_route('serviA.destroy', 'Eliminar', $servis->id,  ['onclick'=>"return confirm('¿Desea Eliminarlo?')" , 'class'=>'btn btn-danger'])!!}
                                      </td></td>
                                    </tr>
                                </tbody>
                                @endforeach
