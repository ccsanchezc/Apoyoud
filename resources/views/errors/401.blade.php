...
<html lang=&quot;es&quot;>
    ...
    <body>
        <div class=&quot;container&quot;>
            <h2><span>401</span><br>Error Acceso Denegado</h2 >
            <h3  style="text-align:center">¡Vaya! Algo salió mal.</h3><br />
            <a href="{{URL::to('')}}"><h3  style="text-align:center">Vuelta Al inicio.</h3><br /></a>
        </div>
    </body>
</html>