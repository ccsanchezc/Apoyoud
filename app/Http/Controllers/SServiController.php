...
class SServiController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
       ...
       $serviciosocial = serviciosocial::servicio($request->get('name'))->orderBy('id','DESC')->paginate(5);
        return view('super.servicio.admviewservi',compact('serviciosocial'));
    }
    ...
    {
        //
        return view('super.servicio.admcreaservi');
    }
    ...
    public function store(ServicioRequest $request)
    {
       ...
       Session::flash('message','Servicio Creado Correctamente');
        return Redirect::to('/super/servi');
    }
    ...
    public function edit($id)
    {
       ...
       return view('super.servicio.admeditservi',['serviciosocial'=>$serviciosocial]);
    }
