...
class SMenuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('super.menu.admviewmenu',compact('menu'));
    }
    ...
    {
        return view('super.menu.admcreamenu');
    }
    ...
    {
        $menu = menu::find($id);
       return view('super.menu.admeditmenu',['menu'=>$menu]);
    }
